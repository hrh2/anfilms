...
export const homeNavigationLinks = [
    { id: 1, title: 'Home', link: '/', icon : <HiHomeModern size={25}/> },
    { id: 2, title: 'Videos',link: '/videos', icon : <MdVideoLibrary size={27}/> },
...
export const teamates = [
    {
      ...
      svg: <svg class="absolute text-white dark:text-gray-700 left-0 bottom-0" xmlns="http://www.w3.org/2000/svg"
...
export const contactus=[
  ...
  label:<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-6 w-6">

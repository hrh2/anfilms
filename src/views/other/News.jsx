  ...
  <section className="mb-32 text-center">
    ...
    <div className="grid gap-6 lg:grid-cols-3 xl:gap-x-12">
      <div className="mb-6 lg:mb-0">
        ...
        <div className="mb-3 flex items-center justify-center text-sm font-medium text-danger !text-danger-500">
        ...
        <p className="mb-6 text-gray-500 !text-gray-300">
      ...
      <div className="mb-6 lg:mb-0">
        ...
        <div className="mb-3 flex items-center justify-center text-sm font-medium text-primary !text-primary-400">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"

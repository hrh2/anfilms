...
export default function AboutUs() {
  return (
    ...
    <h2 class="mb-12 text-3xl font-bold !text-white">
      Meet the <u class="text-green-600">Team</u>
    </h2>

    <div class="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
      {teamates.map((member)=>(
            <div class="mb-6 lg:mb-0" key={member.id}>
            <div
              ...
              <div class="relative overflow-hidden bg-cover bg-no-repeat">
                <img src={member.image} class="w-full rounded-t-lg" alt='' />
                <a href="#!">
              ...
              <div class="p-6">
                ...
                <p class="mb-4 text-gray-500 dark:text-gray-300">{member.title}</p>
                <ul class="mx-auto flex list-inside justify-center">
                  <Link to={`${member.social.instagram}`}  class="px-2">
                      <FaInstagram/>
                  </Link>
                  <Link to={`${member.social.twitter}`}  class="px-2">
                  ...
                  <Link to={`${member.social.linkedin}`} class="px-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"

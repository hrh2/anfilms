...
const LINKS = [
  ...
  {
    title: "Company",
    items: [["About us","checkout/aboutus"], ["Team","checkout/aboutus"], ["News","checkout/news"]]
  },
  {
    title: "Resource",
    items: [["Help center","checkout/contactus"],["Blog","blogs"], ["Newsletter","newsletter"], ["Events","events"]]
  },
];
...
export default function Footer() {
  return (
    <footer className="relative w-full bg-gradient-to-tl from-[#030303f5] to-[#20f48e26]">
      <div className="mx-auto w-full max-w-7xl px-8 py-6">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <Link to="/">
            <Typography variant="h5" className="mb-6 flex items-center align-middle justify-center">
            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title+20}>
                <Typography
                  variant="h5"
                  fontWeight={800}
                  className="mb-3 !text-[#fff] font-medium opacity-40"
                >
                  {title}
                </Typography>
                {items.map((link) => (

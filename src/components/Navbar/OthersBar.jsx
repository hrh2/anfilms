...
export default function OthersBar() {
  ...
  return (
    <nav class="relative flex flex-col items-center justify-center w-full py-2 bg-[#0000009d] lg:py-4">
      <div class="flex mx-auto md:w-[30%] w-[80%] items-center justify-between">
        <input
          type="search"
